...
describe('Index', () => {
    describe('Lint', function () {
        ...
        it('should run eslint without --fix', () => {
            ...
            assert.isTrue(mockCall.command.indexOf(path.normalize('.bin/eslint')) >= 0);
        ...
        it('should run eslint with --fix', () => {
            ...
            assert.isTrue(mockCall.command.indexOf(path.normalize('.bin/eslint') + ' --fix') >= 0);
        });
        ...
        it('should run stylelint without --fix', () => {
            ...
            assert.isTrue(mockCall.command.indexOf(path.normalize('.bin/stylelint')) >= 0);
            assert.isTrue(mockCall.command.indexOf('--fix') < 0);
        });
        ...
        it('should run stylelint with --fix', () => {
            ...
            assert.isTrue(mockCall.command.indexOf(path.normalize('.bin/stylelint') + ' --fix') >= 0);
        });
    });
});
