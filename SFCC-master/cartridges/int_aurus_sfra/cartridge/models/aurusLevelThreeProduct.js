...
function ProductDetails(item) {
    ...
    //this.L3ProductDescription = item.product.longDescription.markup;
     //changed by me
     // Check if item.product and item.product.longDescription are not null or undefined
     this.L3ProductDescription = (item.product && item.product.longDescription) ? item.product.longDescription.markup : '';
